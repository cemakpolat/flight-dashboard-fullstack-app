...
//           direction: Math.random() > 0.8 ? 'left-to-right' : 'right-to-left', // Random direction
//         };
//         console.log('New flight received:', newFlight.direction);
  ...
  useEffect(() => {
    const handleMessage = (topic, message) => {
      try {
        ...
        console.log('New flight received:', newFlight);
        setFlights((prevFlights) => [...prevFlights, newFlight]);
